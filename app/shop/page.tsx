    ...
    <main className="pt-20">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Browse our collection of pizza boxes and packaging solutions</p>
        </div>
            ...
            <div className="hidden md:flex items-center gap-2">
              <button
                className={`border rounded-full px-4 py-2 hover:bg-gray-50 transition-colors ${
                  activeFilters.includes("pizza-boxes") ? "bg-black text-white hover:bg-gray-800" : ""
                }`}
                onClick={() => toggleFilter("pizza-boxes")}
              >
                Pizza Boxes
              </button>
              <button
