...
export default function PizzaBoxesPage() {
  ...
  return (
    <main className="pt-20">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-8">
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2">Pizza Boxes</h1>
          <p className="text-gray-600">High-quality pizza boxes for all your delivery and takeout needs</p>
        </div>
            ...
            <div className="hidden md:flex items-center gap-2">
              <button
                className={`border rounded-full px-4 py-2 hover:bg-gray-50 transition-colors ${
                  activeFilters.includes("standard") ? "bg-black text-white hover:bg-gray-800" : ""
                }`}
              ...
              <button
                className={`border rounded-full px-4 py-2 hover:bg-gray-50 transition-colors ${
                  activeFilters.includes("premium") ? "bg-black text-white hover:bg-gray-800" : ""
                }`}
              ...
              <button
                className={`border rounded-full px-4 py-2 hover:bg-gray-50 transition-colors ${
                  activeFilters.includes("eco") ? "bg-black text-white hover:bg-gray-800" : ""
                }`}
